...
**Thank you for helping build the best GitHub Copilot instruction set!**

## 🎯 Why Contribute?

Every time you encounter a Copilot error, find a way to improve its output, or discover a pattern that generates better code - **the entire community benefits** when you share it.

This project's goal is simple: **create the most comprehensive set of instructions** to make GitHub Copilot as accurate and helpful as possible for everyone.

## 💡 The Philosophy

GitHub Copilot is powerful, but it can:
- Invent non-existent functions or APIs (hallucinations)
- Lose context in long conversations
- Generate inconsistent code patterns
- Miss edge cases or security issues

**Your contributions fix these problems for thousands of developers.**
...
3. **Test** - verify your changes actually improve Copilot's behavior
4. **Submit a Pull Request** - explain what problem you solved
...
#### 🔥 High Priority
- **Copilot hallucinations** you've encountered (inventing non-existent functions, APIs, methods)
- **Instructions that fixed a bug** or prevented an error in your code
- **Context management** - ways to keep Copilot accurate across long conversations
- **Language-specific patterns** - TypeScript, Python, C#, Go, Rust, etc.
- **Framework guidelines** - React, Next.js, Express, FastAPI, Django, etc.
